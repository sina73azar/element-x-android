...
class CalendarStyle(context: Context) {
    ...
    val InvalidTodayStyle: CalendarItemStyle
    ...
    init {
        ...
        InvalidTodayStyle = CalendarItemStyle.create(
            context,
            calendarAttributes.getResourceId(R.styleable.PersianMaterialCalendar_InvalidTodayStyle, 0)
        )
