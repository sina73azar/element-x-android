...
fun LastTenStatementInquiryBottomSheet(
    ...
    DynamicSheet(
        ...
        title = stringResource(
            id = com.drp.card_facilities.R.string.card_statement_st
        ),
        snackBarHost = snackBarHost
    ) {
        Column(modifier = Modifier.padding(top = dimensionResource(id = UIResources.dimen.medium_padding))) {
            ...
            SubmitCancelRowCompose(
                submitText = stringResource(id = com.drp.card_facilities.R.string.ok),
                onSubmitClick = {
                    viewModel?.sendEvent(
                ...
                dismissText = stringResource(id = com.drp.card_facilities.R.string.cancel),
