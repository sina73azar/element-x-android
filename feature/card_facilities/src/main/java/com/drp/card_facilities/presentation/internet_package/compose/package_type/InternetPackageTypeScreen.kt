...
fun InternetPackageTypeScreen(
    ...
    Scaffold(snackbarHost = {
        ...
        CustomTopAppBar(
            headerTxt = stringResource(id = com.drp.card_facilities.R.string.internet_package_title),
            onBackClick = {
        ...
        Column(
            ...
            LazyColumn {
                ...
                item {
                    Spacer(modifier = Modifier.height(dimensionResource(id = UIResources.dimen.medium_padding)))
                }
            }
        }
...
fun PackageItemCard(
    ...
    ElevatedCard(modifier = modifier
        ...
        .padding(top = dimensionResource(id = UIResources.dimen.medium_padding)),
        ...
        Row(
            ...
            Text(
                modifier = Modifier
                    .padding(start = dimensionResource(id = UIResources.dimen.medium_padding))
                    .weight(1f),
            ...
            Text(
                modifier = Modifier
                    .wrapContentWidth()
                    .padding(end = dimensionResource(id = UIResources.dimen.small_padding)),
            ...
            Text(
                modifier = Modifier
                    .padding(end = dimensionResource(id = UIResources.dimen.medium_padding))
                    .background(
                    ...
                    .wrapContentWidth(),
                text = stringResource(id = UIResources.string.irr_currency),
...
fun Chip(
    ...
    Surface(
        modifier = Modifier
            .padding(vertical = dimensionResource(id = UIResources.dimen.small_padding))
            .padding(start = dimensionResource(id = UIResources.dimen.small_padding)),
        shadowElevation = 4.dp,
        shape = RoundedCornerShape(dimensionResource(id = UIResources.dimen.extra_large_corner)),
        ...
        Row(modifier = Modifier
            ...
            .padding(dimensionResource(id = UIResources.dimen.small_padding)),
            verticalAlignment = Alignment.CenterVertically,
            horizontalArrangement = Arrangement.Center
        ) {
            /*Icon(
            ...
            Text(
                ...
                modifier = Modifier.padding(horizontal = dimensionResource(id = UIResources.dimen.small_padding))
            )
        }
    }
}
