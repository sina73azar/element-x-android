package com.drp.card_facilities.presentation.wallet_add.transfer
...
import com.drp.card_facilities.presentation.wallet_add.WalletAddScreenEvents
import com.drp.card_facilities.presentation.wallet_add.WalletAddScreenState
import com.drp.card_facilities.presentation.wallet_add.WalletAddViewModel
...
@Composable
fun TransferToWalletBottomSheet(
    ...
    DynamicSheet(
        ...
        title = stringResource(
            id = R.string.increase_balance_st
        ),
        ...
        LazyColumn {
            ...
            item {
                SubmitCancelRowCompose(
                    ...
                    onSubmitClick = {
                        viewModel?.sendEvent(
                            WalletAddScreenEvents.Transfer
                        )
