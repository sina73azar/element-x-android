...
import com.drp.card_facilities.utility.enums.BillTabs
        ...
        Column(modifier = modifier.padding(top = paddingValues.calculateTopPadding())) {
            TabRow(
                modifier = Modifier
                    ...
                    .clip(
                        RoundedCornerShape(dimensionResource(id = UiRes.dimen.large_corner))
                    ),
                ...
                tabTitles.forEachIndexed { index, title ->
                    ...
                    Tab(
                        ...
                        modifier = Modifier.heightIn(min = dimensionResource(id = UiRes.dimen.button_height)),
                    )
                }
            }
            when (selectedTab) {
...
//                            modifier = Modifier.padding(top = dimensionResource(id = UiRes.dimen.small_padding)),
                    ...
                    ElevatedCard(
                        modifier = modifier
                            ...
                            .padding(vertical = dimensionResource(id = UiRes.dimen.medium_padding)),
                        ...
                        BankEditTextExposed(
                            modifier = Modifier.padding(top = dimensionResource(id = UiRes.dimen.large_padding)),
                        ...
                        if (uiState.cardOrWalletToggle?.id == 1) {
                            ...
                            Row(
                                modifier = Modifier
                                    .fillMaxWidth()
                                    .padding(horizontal = dimensionResource(id = UiRes.dimen.extra_large_padding))
                                    .padding(top = dimensionResource(id = UiRes.dimen.small_padding))
                            ) {
                                Combo(
                                ...
                                Spacer(modifier = Modifier.width(dimensionResource(id = UiRes.dimen.medium_padding)))
                                Combo(
                                    modifier = Modifier.weight(0.5f),
                        ...
                        LoadingButton(
                            modifier = Modifier
                                ...
                                .padding(
                                    top = 24.dp,
                                    bottom = dimensionResource(id = UiRes.dimen.large_padding)
                                ),
                            loading = uiState.billInquiryState.isLoading(),
                            paddingHorizontal = dimensionResource(id = UiRes.dimen.large_padding),
                            onClick = {
