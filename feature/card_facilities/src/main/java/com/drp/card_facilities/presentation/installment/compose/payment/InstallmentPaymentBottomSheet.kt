package com.drp.card_facilities.presentation.installment.compose.payment
...
fun InstallmentPaymentBottomSheet(
    ...
    DynamicSheet(
        ...
        icon = UiRes.drawable.ic_hamrah_card,
        onDismiss = dismiss,
        title = stringResource(
            id = R.string.installment_title
        ),
        ...
        LazyColumn {
            ...
            item {
                OTPPasswordEditTextCompose(
                    ...
                    readOnly = false,
                    otpSmsRequest = {
                        viewModel?.sendEvent(InstallmentEvents.SendOtp)
                    },
            ...
            item {
                SubmitCancelRowCompose(
                    ...
                    onSubmitClick = {
                        viewModel?.sendEvent(InstallmentEvents.Payment)
                    },
                    dismissText = stringResource(id = R.string.cancel),
                    onSubmitLoading = uiState.installmentPayment.isLoading()
                ) {
        ...
        LaunchedEffect(key1 = uiState.installmentPayment) {
            uiState.installmentPayment.let { paymentState ->
