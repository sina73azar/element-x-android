...
import io.element.android.x.navigation.MainScreens
...
fun AppBottomBar(navController: NavHostController, viewModel: MainViewModel? = null) {
    ...
    val bottomBarItems = listOf(
        ...
        BottomBarItemData(
            ...
            onClick = {
                navController.navigate(route = MainScreens.MessengerScreen.route) {
                    popUpTo(route = MainScreens.HomeScreen.route) {
                        inclusive = false
                    }
                }
                        ...
                        Card(
                            modifier = Modifier
                                .padding(
                                    horizontal = dimensionResource(
                                        id = com.drp.shared_ui.R.dimen.medium_padding
                                    )
                                )
                                .size(64.dp),
                            ...
                            elevation = CardDefaults.elevatedCardElevation(
                                defaultElevation = dimensionResource(
                                    id = com.drp.shared_ui.R.dimen.small_elevation
                                )
                            ),
