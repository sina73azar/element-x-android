...
import com.drp.data.model.motor_violation.MotorViolationRequest
...
import com.drp.data.model.vehicle_violation.VehicleViolationRequest
...
//            headers = mapOf("Authorization" to "Basic d2FsbGV0OmFzZDEyMyFAIw=="),
    ...
    override fun vehicleViolationInquiry(
        leftNumber: String,
        alphabetic: String,
        midNumber: String,
        rightNumber: String,
        ...
        val request = VehicleViolationRequest(
            left = leftNumber,
            alphabet = alphabetic,
            mid = midNumber,
            right = rightNumber,
        ...
        return dynamicApiCall.dynamicPostCall(
            url = EndPoints.VEHICLE_VIOLATION_INQUIRY_END_POINT,
            request = request,
            kClass = VehicleViolationResponse::class.java
        )
    }

    override fun motorViolationInquiry(
        leftNumber: String,
        rightNumber: String,
        mobileNumber: String,
        nationalId: String,
        ...
        val request = MotorViolationRequest(
            left = leftNumber,
            right = rightNumber,
            mobileNumber = mobileNumber,
            nationalID = nationalId,
        ...
        return dynamicApiCall.dynamicPostCall(
            url = EndPoints.MOTOR_VIOLATION_INQUIRY_END_POINT,
            request = request,
            kClass = MotorViolationResponse::class.java
        )
    }
