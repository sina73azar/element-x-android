...
fun Combo2(
    ...
    )
    {
        OutlinedTextField(
            ...
            shape = if (withoutCorner) RoundedCornerShape(0.dp) else RoundedCornerShape(8.dp),
            readOnly = true,
            leadingIcon =
            if (iconRight != null) {
                @Composable {
                    Icon(imageVector = iconRight, contentDescription = "right_icon")
                }
            } else null,
            trailingIcon =
            if (isLoading) {
