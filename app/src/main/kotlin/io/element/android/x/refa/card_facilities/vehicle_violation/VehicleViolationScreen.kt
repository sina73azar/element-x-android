...
import com.drp.shared_ui.widget.CarLicencePlateWidget
...
@Composable
fun VehicleViolationScreen(
    modifier: Modifier = Modifier,
    viewModel: VehicleViolationViewModel? = null,
    navController: NavHostController = rememberNavController(),
) {

    val uiState = viewModel?.uiState?.collectAsStateWithLifecycle()?.value
        ?: VehicleViolationScreenState()
    ...
    Scaffold(
        ...
        topBar = {
            CustomTopAppBar(
                headerTxt = stringResource(id = R.string.vehicle_violation_inquiry_title_st),
                onBackClick = {
        ...
        Column(modifier = modifier.padding(top = paddingValues.calculateTopPadding())) {
            ElevatedCard(
                ...
                CarLicencePlateWidget(
                    ...
                    midValue = uiState.midNumber,
                    onMidValueChange = { viewModel?.setMidNumber(it) },
                    midError = uiState.midNumberError,
                    dumpMidError = { viewModel?.dismissMidNumberError() },
                    ...
                    alphabeticValue = uiState.alphabetic,
                    onAlphabeticValueChange = { viewModel?.setAlphabetic(it) },
                    alphabeticError = uiState.alphabeticError,
                    dumpAlphabeticError = { viewModel?.dismissAlphabeticError() }
                )
                BankEditTextExposed(
...
@Composable
private fun VehicleViolationScreenPreview() {
    ApplicationTheme {
