...
/**
 * Created by sharafkar.a on 10/15/2017.
 */
...
class JalaliCalendar {
        ...
        get() {
            ...
            for (j in 1..19) {
                ...
                if (jalaliYear < jm) {
                    ...
                    marchDay = 20 + (jalaliLeap - myGregorianLeap)
    ...
    internal constructor(gregorianCalendar: GregorianCalendar) {
        fromGregorian(gregorianCalendar)
    }

    fun setGregorianCalendar(gregorianCalendar: GregorianCalendar) {
        fromGregorian(gregorianCalendar)
    }
